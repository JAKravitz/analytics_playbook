# Threshold Alert API (`forest-threshold-alert-api`)

## Document control
- **API ID:** forest-threshold-alert-api
- **Verticals:** forestry
...
## Spectral uplift
- **MSI baseline:** Index-threshold alerts.
- **VNIR HSI adds:** Earlier trigger via biochemical indicators — degradation and disturbance alerts ahead of MSI-detectable canopy loss.
- **VNIR-SWIR HSI adds:** Earlier still for structural disturbance types detectable only in SWIR.
