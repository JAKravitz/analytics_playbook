...
**Catalog notes:** PROSAIL inversion, calibrated uncertainty
...
Primary deliverable: **LAI** geospatial layer(s). Auxiliary QA or confidence bands may be included where the product line defines them. Delivery format and tiling follow the standard customer delivery spec for the order.
