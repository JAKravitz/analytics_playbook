# Terrain Soil Moisture (Cw-derived) (`l104`)
...
**Catalog notes:** Mobility / trafficability input
...
Primary deliverable: **Terrain Soil Moisture (Cw-derived)** geospatial layer(s). Auxiliary QA or confidence bands may be included where the product line defines them. Delivery format and tiling follow the standard customer delivery spec for the order.
