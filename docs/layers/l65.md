...
**Catalog notes:** Stock change signal; exploration grade
...
Primary deliverable: **Carbon Change Detection** geospatial layer(s). Auxiliary QA or confidence bands may be included where the product line defines them. Delivery format and tiling follow the standard customer delivery spec for the order.
