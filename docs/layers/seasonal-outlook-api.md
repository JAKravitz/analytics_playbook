# Seasonal Outlook API (`seasonal-outlook-api`)

## Document control
- **API ID:** seasonal-outlook-api
...
## Spectral uplift
- **MSI baseline:** Short-horizon outlook from index trajectories.
- **VNIR HSI adds:** Earlier-season risk detection extends forecast horizon.
- **VNIR-SWIR HSI adds:** SWIR-derived structural signals improve outlook stability across phenological stages.

## Purpose and scope
Add-on API endpoint composed on top of the Core API base package; sold per-subscription.

**Catalog notes:** Forward-looking seasonal risk projection.
