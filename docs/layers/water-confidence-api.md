# Confidence API (`water-confidence-api`)

## Document control
- **API ID:** water-confidence-api
- **Verticals:** water
- **Kind:** core
...
- **VNIR HSI adds:** Confidence informed by spectral fit quality across VNIR water features
- **VNIR-SWIR HSI adds:** Full-curve spectral fit including SWIR — tighter uncertainty bounds on CDOM, TSM, and IOP retrievals
