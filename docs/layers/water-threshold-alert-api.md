# Threshold Alert API (`water-threshold-alert-api`)

## Document control
- **API ID:** water-threshold-alert-api
- **Verticals:** water
...
- **VNIR HSI adds:** Earlier trigger via spectrally-specific constituent retrievals — phycocyanin and Chl-a alerts ahead of MSI-detectable bloom signals
- **VNIR-SWIR HSI adds:** Earlier still via SWIR-constrained constituent retrievals in optically complex waters
