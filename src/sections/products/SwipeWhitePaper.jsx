...
import { waterWhitePaper as wp, waterFigures } from '../../data/products/water.js';

const ASSET_BASE = '/product-assets/water/';

function Figure({ slot }) {
  const fig = waterFigures[slot];
...
export default function SwipeWhitePaper() {
  return (
